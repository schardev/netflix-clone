import { Check, InfoEmpty, PlayOutline, Plus } from "iconoir-react";
...
type BannerState = ((MovieDetails | TVDetails) & { images?: Images }) | null;
    ...
    <div className={styles["banner-container"]}>
      ...
      <div className={styles["banner-info"]}>
        ...
        <ul className={styles["banner-menu"]}>
          ...
          <li>
            <button onClick={() => navigate(`/${category}/${data.id}`)}>
              <PlayOutline />
              <span>Play</span>
            </button>
          </li>
